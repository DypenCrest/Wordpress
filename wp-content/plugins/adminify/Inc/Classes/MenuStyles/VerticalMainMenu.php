    ...
    public function render_sub_level_menu_items($sub_menu,$parent_menu,$menu_options)
    {
        ...
        <ul class="wp-adminify-nav-sub wp-submenu wp-submenu-wrap">
            ...
            foreach ($sub_menu as $sub_item) {
                ...
                if(str_contains($parent_menu[5], 'adminify-custom-menu-')){
                    if(str_contains($custom_submenu, 'adminify-custom-submenu-')){
        ...
        if (!$theicon) {
            if (strpos($wpicon, 'http') !== false || strpos($wpicon, 'data:') !== false) {
                ...
                if(strpos($wpicon, 'http') !== false){
                    ...
                    $wpicon = str_contains($wpicon,',') ? explode(',',$wpicon)[1] : $wpicon;
                }
            ?>
            ...
            <?php
                ...
                if( empty($wpicon) ){
                    ...
                    $wpicon =  str_contains($wpicon,'dashicons-') ? 'dashicons-before '. $wpicon : $wpicon;
                    ?>
