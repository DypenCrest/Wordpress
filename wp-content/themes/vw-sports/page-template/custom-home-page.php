...
<main id="maincontent" role="main">
              ...
              <div class="carousel-caption">
                <div class="slider-inner-box">
                  <?php if( get_theme_mod('vw_sports_slider_title_hide_show',true) != ''){ ?>
                    <h1 class="mb-0 pt-0 <?php if( get_theme_mod( 'vw_sports_animation', true) != '') { ?> wow slideInRight delay-1000" data-wow-duration="3s"<?php } else { ?> heading mb-0 pt-0 <?php } ?>"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h1>
                  <?php } ?>
                  <?php if( get_theme_mod('vw_sports_slider_content_hide_show',true) != ''){ ?>
                    <p class="mt-2 <?php if( get_theme_mod( 'vw_sports_animation', true) != '') { ?> wow slideInLeft delay-1000" data-wow-duration="3s"<?php } else { ?> cont mt-2 <?php } ?>"><?php $excerpt = get_the_excerpt(); echo esc_html( vw_sports_string_limit_words( $excerpt, esc_attr(get_theme_mod('vw_sports_slider_excerpt_number','30')))); ?></p>
                  <?php }?>
                  <?php if( get_theme_mod('vw_sports_slider_button_text','READ MORE') != ''){ ?>
                    <div class="<?php if( get_theme_mod( 'vw_sports_animation', true) != '') { ?> more-btn my-3 my-lg-5 my-md-4 wow rollIn delay-1000" data-wow-duration="3s"<?php } else { ?> more-btn my-3 my-lg-5 my-md-4 <?php } ?>">
  ...
  <section id="services-sec" class="<?php if( get_theme_mod( 'vw_sports_animation', true) != '') { ?> py-5 text-center wow bounceInRight delay-1000" data-wow-duration="2s"<?php } else { ?> services py-5 text-center <?php } ?>">
    <div class="container">
