...
<div class="container">
	<main id="maincontent" role="main">
		<div class="page-content">
	    	<h1><?php esc_html_e('Access Denied!','vw-sports');?></h1>
			<p class="text-404"><?php esc_html_e('Sorry! This page is only accessible to Admin and Moderators Right Now.','vw-sports');?></p>
