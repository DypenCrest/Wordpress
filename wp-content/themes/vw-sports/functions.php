...
define('VW_SPORTS_CREDIT',__('https://olympics.com/en/olympic-games/beijing-2022','vw-sports'));

if ( ! function_exists( 'vw_sports_credit' ) ) {
	function vw_sports_credit(){
		echo "<a href=".esc_url(VW_SPORTS_CREDIT)." target='_blank'>".esc_html__('Olympics','vw-sports')."</a>";
	}
}
