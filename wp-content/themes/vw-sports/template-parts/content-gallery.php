...
<div id="post-<?php the_ID(); ?>" <?php post_class('inner-service'); ?>>
  <div class="<?php if( get_theme_mod( 'vw_sports_animation', true) != '') { ?> post-main-box p-3 mb-3 wow zoomInUp delay-1000" data-wow-duration="2s"<?php } else { ?> post-main-box p-3 mb-3 <?php } ?>">
    <?php
      if ( ! is_single() ) {
