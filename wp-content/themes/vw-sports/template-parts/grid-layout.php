...
<div class="col-lg-4 col-md-6">
	<article id="post-<?php the_ID(); ?>" <?php post_class('inner-service'); ?>>
		<div class="<?php if( get_theme_mod( 'vw_sports_animation', true) != '') { ?> post-main-box p-3 mb-3 text-center wow zoomInUp delay-1000" data-wow-duration="2s"<?php } else { ?> post-main-box p-3 mb-3 text-center <?php } ?>">
	      	<div class="box-image">
	          	<?php 
